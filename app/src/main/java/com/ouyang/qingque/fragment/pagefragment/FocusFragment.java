...
public class FocusFragment extends BasePagerFragment {
    ...
    protected void toHeaderAnim(){
        ...
        if(toX<b){
            ((QwanFragment)(FocusFragment.this.getParentFragment())).getRl_quewan().setY(DeviceUtil.dip2px(getActivity(),15));
            ((QwanFragment)(FocusFragment.this.getParentFragment())).getmLinearLayout().setX(0);
    ...
    public void updateDataToView(RecyclerView recyclerView, int dx, int dy) {
        ...
        if(Math.abs(view.getTop())<=headerHeight&&mCurrentPosition==0){
            if(view.getTop()<0){
                //减去三个圆点所占高度的一半
                ((QwanFragment)(FocusFragment.this.getParentFragment())).getRl_quewan().setY(-(headerHeight-DeviceUtil.dip2px(getActivity(),10)));
                //减去三个圆点所占宽度的一半
                ((QwanFragment)(FocusFragment.this.getParentFragment())).getmLinearLayout().setX((screenWidth/2-DeviceUtil.dip2px(getActivity(),50)));
                ...
                ((QwanFragment)(FocusFragment.this.getParentFragment())).getRl_quewan().setY(toY);
                ((QwanFragment)(FocusFragment.this.getParentFragment())).getmLinearLayout().setX(toX);
            }
        }
